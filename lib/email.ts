...
export async function sendWelcomeEmail(to: string, name: string, password: string, role: string, negotiator?: NegotiatorInfo) {
  ...
  const tips = [
    "Pensez à votre entourage : famille, amis, collègues, voisins… tout le monde connaît quelqu'un avec un projet immobilier.",
    "Le timing est clé : quelqu'un qui parle de déménager, d'investir ou de vendre, c'est le moment de recommander !",
    negotiator
      ? `Vous pouvez échanger directement avec ${negotiator.name} via la messagerie intégrée pour valider ensemble la pertinence d'un contact.`
      : "Vous pouvez nous appeler à tout moment pour valider ensemble la pertinence d'un contact avant de le recommander.",
    "Chaque recommandation qui aboutit à une transaction vous rapporte 5% des honoraires — sans plafond ni limite de recommandations.",
    "Pour recommander un proche, rendez-vous sur votre espace et cliquez sur « Recommander » : c'est simple et rapide.",
  ];

  const tipsHtml = tips.map(t =>
    `<tr><td style="padding: 8px 0; vertical-align: top; width: 24px; color: #D1B280; font-size: 16px;">&#10022;</td><td style="padding: 8px 0 8px 8px; color: #444; font-size: 14px; line-height: 1.5;">${t}</td></tr>`
  ).join("");
...
<table width="600" cellpadding="0" cellspacing="0" style="background:#ffffff; max-width:600px;">
  ...
  <tr>
    <td align="center" style="background:#030A24; padding: 35px 40px; text-align: center;">
      ...
      <p style="color:#ffffff60; font-size:11px; margin:5px 0 0 0; font-family: Arial, sans-serif;">depuis 1969</p>
    </td>
  </tr>
  ...
  <tr>
    <td style="padding: 40px 40px 20px 40px;">
      ...
      <p style="color:#D1B280; font-size:13px; margin:0; font-weight:600; text-transform:uppercase; letter-spacing:1px; font-family: Arial, sans-serif;">${roleLabel}</p>
    </td>
  </tr>
  ...
  <tr>
    <td style="padding: 0 40px 25px 40px;">
      <p style="color:#333; font-size:15px; line-height:1.7; margin:0; font-family: Arial, sans-serif;">
        Félicitations ! Votre espace ${roleLabel.toLowerCase()} a été créé sur <strong>The Club : La Brie Immobilière</strong>.
        Vous faites désormais partie de notre réseau de partenaires privilégiés.
      </p>
    </td>
  </tr>
      ...
      <table width="100%" cellpadding="0" cellspacing="0" style="background:#030A24;">
        <tr>
          <td style="padding: 25px 30px;">
            <p style="color:#D1B280; font-size:11px; letter-spacing:2px; margin:0 0 15px 0; text-transform:uppercase; font-weight:600; font-family: Arial, sans-serif;">
            ...
            <table cellpadding="0" cellspacing="0" border="0" width="100%">
              <tr>
                ...
                <td style="vertical-align:top; width:70px; padding-right:15px;">
                  <img src="cid:negphoto" alt="${negotiator.name}" width="60" height="60" style="display:block; width:60px; height:60px; object-fit:cover; border:2px solid #D1B280;" />
                </td>
                ` : ""}
                <td style="vertical-align:top;">
                  <p style="margin:0 0 2px 0; font-size:18px; color:#ffffff; font-weight:700; font-family: Arial, sans-serif;">${negotiator.name}</p>
                  <p style="margin:0 0 10px 0; font-size:13px; color:#D1B280; font-family: Arial, sans-serif;">Négociateur — Agence de ${negotiator.agencyName}</p>
                  <table cellpadding="0" cellspacing="0" border="0">
                    <tr>
                      <td style="padding: 3px 0;">
                        <span style="color:#D1B280; font-size:14px;">&#9993;</span>
                        <a href="mailto:${negotiator.email}" style="color:#ffffff; text-decoration:none; font-size:14px; margin-left:8px; font-family: Arial, sans-serif;">${negotiator.email}</a>
                      </td>
                    </tr>
                    ${negotiator.phone ? `
                    <tr>
                      <td style="padding: 3px 0;">
                        <span style="color:#D1B280; font-size:14px;">&#128222;</span>
                        <span style="color:#ffffff; font-size:14px; margin-left:8px; font-family: Arial, sans-serif;">${negotiator.phone}</span>
                      </td>
                    </tr>
                    ` : ""}
                  </table>
            ...
            <p style="color:#ffffff60; font-size:12px; margin:12px 0 0 0; line-height:1.5; font-family: Arial, sans-serif;">
              ${negotiator.name} est votre contact privilégié. N'hésitez pas à le solliciter pour toute question sur le programme ou pour qualifier un contact avant de le recommander.
            </p>
          </td>
        </tr>
      </table>
  ...
  <tr>
    <td style="padding: 30px 40px 10px 40px;">
      <h2 style="color:#030A24; font-size:16px; margin:0 0 5px 0; font-family: 'Fira Sans', Arial, sans-serif;">
        &#128161; Nos conseils pour maximiser vos recommandations
      </h2>
      <p style="color:#888; font-size:13px; margin:0 0 15px 0; font-family: Arial, sans-serif;">
        Quelques astuces pour augmenter vos chances de mise en relation :
      </p>
    </td>
  </tr>
  <tr>
        ...
        <tr>
          <td style="padding: 25px 30px; text-align:center;">
            <p style="color:#D1B280; font-size:15px; font-style:italic; margin:0 0 8px 0; line-height:1.5; font-family: Georgia, serif;">
              &laquo; Chaque recommandation est une marque de confiance. Nous nous engageons à offrir à vos contacts le même niveau d'exigence que celui que vous attendez de nous. &raquo;
            </p>
            <p style="color:#ffffff60; font-size:12px; margin:0; font-family: Arial, sans-serif;">— L'équipe La Brie Immobilière</p>
          </td>
        </tr>
      </table>
    </td>
  ...
  <tr>
    <td style="padding: 0 40px 30px 40px;">
      <p style="color:#666; font-size:13px; line-height:1.6; margin:0; font-family: Arial, sans-serif;">
        Une question ? Contactez-nous :<br/>
        <strong style="color:#030A24;">&#9742; ${agency.phone}</strong> &nbsp;|&nbsp;
        <a href="mailto:${agency.email}" style="color:#D1B280; text-decoration:none; font-weight:600;">${agency.email}</a>
      </p>
    </td>
  </tr>
  ...
  <tr>
    <td style="background:#030A24; padding: 25px 40px; text-align: center;">
      ...
      <p style="color:#ffffff20; font-size:10px; margin:4px 0 0 0; font-family: Arial, sans-serif;">
        <a href="${process.env.NEXTAUTH_URL}" style="color:#ffffff40; text-decoration:none;">${agency.website}</a>
      </p>
    </td>
  </tr>
