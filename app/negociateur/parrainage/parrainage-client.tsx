        ...
        <div className="p-4 sm:p-6 space-y-5">
          ...
          <div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 sm:gap-3">
              <code className="flex-1 bg-[#030A24] text-[#D1B280] px-3 sm:px-5 py-3 text-base sm:text-xl font-mono font-bold tracking-wider sm:tracking-widest text-center break-all">
                {code}
              </code>
